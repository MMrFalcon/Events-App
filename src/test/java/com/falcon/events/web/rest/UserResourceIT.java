...
import com.falcon.events.service.mapper.UserMapper;
...
public class UserResourceIT {
    ...
    public void createUser() throws Exception {
        ...
        managedUserVM.setAuthorities(Collections.singleton(AuthoritiesConstants.MEMBER));
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(hasItems(AuthoritiesConstants.MEMBER, AuthoritiesConstants.ADMIN)));
    }
    ...
    public void testUserDTOtoUser() {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.MEMBER));
        ...
        assertThat(user.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.MEMBER);
    }
    ...
    public void testUserToUserDTO() {
        ...
        assertThat(userDTO.getAuthorities()).containsExactly(AuthoritiesConstants.MEMBER);
    ...
    public void testAuthorityEquals() {
        ...
        authorityA.setName(AuthoritiesConstants.MEMBER);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setName(AuthoritiesConstants.MEMBER);
        assertThat(authorityA).isEqualTo(authorityB);

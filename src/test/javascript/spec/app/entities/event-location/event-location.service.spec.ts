...
describe('Service Tests', () => {
  describe('EventLocation Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new EventLocation(0, 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a EventLocation', async () => {
      ...
      it('should update a EventLocation', async () => {
        const returnedFromService = Object.assign(
          {
            locationName: 'BBBBBB',
            eventDayOfWeek: 1
      ...
      it('should return a list of EventLocation', async () => {
        const returnedFromService = Object.assign(
          {
            locationName: 'BBBBBB',
            eventDayOfWeek: 1
      ...
      it('should delete a EventLocation', async () => {

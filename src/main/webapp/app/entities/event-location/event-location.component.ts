...
export class EventLocationComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.eventLocationService
      ...
      .subscribe(
        (res: HttpResponse<IEventLocation[]>) => this.paginateEventLocations(res.body, res.headers),
  ...
  registerChangeInEventLocations() {
    this.eventSubscriber = this.eventManager.subscribe('eventLocationListModification', response => this.loadAll());
  }
